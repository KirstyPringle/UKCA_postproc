#User defined values - only change these in here!
...
dir_scripts='/home/users/dgrosven/py/tools/UM_pp_conversion_Jesus_CLEAN_for_push/UKCA_postproc/'
...
#run_L0=0
run_L1=False                 # if true will calculate additional output as a postprocessing step e.g. CCN 
...
# Location of the UM output files to procesdirectory='/nfs/a201/eejvt/CASIM/SECOND_CLOUD/GP_HAM_DMDUST/'    
#input_files_directory='/nfs/a201/eejvt/CASIM/SECOND_CLOUD/GP_HAM_DMDUST/'    
input_files_directory='/group_workspaces/jasmin2/asci/dgrosv/Iceland/u-ba050/'
